...
def main():
    ...
    housing_downloads_path = path + r'\Downloaded data\Housing Data'
    ...
    pollutant_downloads_path = path + r'\Downloaded data\Pollutant Data'
    ...
    SingleFamilyData.to_csv(path+r'\Collated data\Housing_data.csv', index=False)
    ...
    pollutant_data_path = (path+r'\Collated data')
